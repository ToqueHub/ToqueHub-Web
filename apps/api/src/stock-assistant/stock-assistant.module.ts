...
@Module({ imports: [StocksModule, MistralModule], controllers: [StockAssistantController], providers: [StockAssistantService, StockAgentHarnessService, StockAgentService, ProductMatchingService] })
