...
export function App() {
  ...
  async function handleSetupOrganization(payload: { name: string; code?: string; establishmentType?: string; teamSize?: string; regulatoryCountryCode?: 'FR' | 'FI'; logoDataUrl?: string }) {
...
function SetupOrganizationPage({
  ...
  onSubmit: (payload: { name: string; code?: string; establishmentType?: string; teamSize?: string; regulatoryCountryCode?: 'FR' | 'FI'; logoDataUrl?: string }) => Promise<void>;
  onBackHome: () => void;
}) {
