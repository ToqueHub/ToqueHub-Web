export const englishOverrides: Readonly<Record<string, string>> = {
  ...
  'Vous ne pouvez pas gérer les presets opérationnels.':
    'You cannot manage operational presets.',
  Continuer: 'Continue',
  Retour: 'Back',
  Suivant: 'Next',
  Terminer: 'Finish',
...
export const finnishOverrides: Readonly<Record<string, string>> = {
  Favoris: 'Suosikit',
  '⭐ Favoris': '⭐ Suosikit',
  'Produit favori': 'Suosikkituote',
  'Ajouter aux favoris': 'Lisää suosikkeihin',
  'Retirer des favoris': 'Poista suosikeista',
  'Produit ajouté aux favoris.': 'Tuote lisättiin suosikkeihin.',
  'Produit retiré des favoris.': 'Tuote poistettiin suosikeista.',
  'Impossible de modifier ce favori.': 'Suosikkia ei voitu päivittää.',
  'Entrée en stock :': 'Varastoon:',
  'unités de stock': 'varastoyksikköä',
  'Produits de la carte': 'Ruokalistan tuotteet',
  'Presets opérationnels': 'Operatiiviset esiasetukset',
  'Presets récurrents': 'Toistuvat esiasetukset',
  'Planning opérationnel automatique': 'Automaattinen operatiivinen suunnittelu',
  'Nouveau preset': 'Uusi esiasetus',
  'Nouveau preset opérationnel': 'Uusi operatiivinen esiasetus',
  'Modifier le preset': 'Muokkaa esiasetusta',
  'Créer le preset': 'Luo esiasetus',
  'Aucun preset opérationnel': 'Ei operatiivisia esiasetuksia',
  'Jour(s) où le produit est servi': 'Päivä(t), jolloin tuote tarjoillaan',
  'Préparer combien de jours avant ?': 'Kuinka monta päivää etukäteen valmistetaan?',
  'Fiche technique à produire': 'Valmistettava resepti',
  'Étape précise (optionnel)': 'Tietty vaihe (valinnainen)',
  'Retirer cette occurrence': 'Poista tämä esiintymä',
  'Activer immédiatement ce preset': 'Aktivoi tämä esiasetus heti',
  'Fin de récurrence (optionnel)': 'Toistumisen päättyminen (valinnainen)',
  'Consignes visibles dans le planning opérationnel':
    'Operatiivisessa suunnitelmassa näkyvät ohjeet',
  'Attribuez les préparations récurrentes par service et collaborateur. Elles sont déposées automatiquement au bon jour et à la bonne heure dans le planning.':
    'Määritä toistuvat valmistelutehtävät palvelun ja työntekijän mukaan. Ne sijoitetaan automaattisesti suunnitelmaan oikealle päivälle ja kellonajalle.',
  'Créez par exemple « Croissants du samedi » avec une préparation automatique le vendredi.':
    'Luo esimerkiksi ”Lauantain croissantit”, joiden valmistelu tehdään automaattisesti perjantaina.',
  'Choisir la langue de l’application': 'Valitse sovelluksen kieli',
  'Passer en finnois': 'Vaihda suomeksi',
  Français: 'Ranska',
  Anglais: 'Englanti',
  Finnois: 'Suomi',
};
