...
\[
\mathrm{v} (\mathrm{f}) (\mathrm{m}) = \mathrm{e} (\mathrm{f}) (\mathrm{m}) \mathrm{b} (\mathrm{m}) = \sum_ {i} \mathrm{e} _ {i} (\mathrm{f}) (\mathrm{m}) \mathrm{b} ^ {i} (\mathrm{m}), \tag {4.1}
\]
...
\[
\tilde {\mathbf {e}} ^ {i} (\mathbf {e} _ {j}) (\mathbf {m}) = \delta_ {j} ^ {i} \tag {4.2}
\]
