...
$$M - Q(h) = c_p h^p + \mathcal{O}(h^{p+1}), \tag{3.15a}$$

$$M - Q(2h) = c_p (2h)^p + \mathcal{O}(h^{p+1}). \tag{3.15b}$$
...
$$M = \frac{2^p Q(h) - Q(2h)}{2^p - 1} + \mathcal{O}(h^{p+1}). \tag{3.16}$$
...
$$f'(x) - Q_f(h) = c_1 h + \mathcal{O}(h^2), \tag{3.17}$$

and the difference for $2h$ equals

$$f'(x) - Q_f(2h) = c_1 2h + \mathcal{O}(h^2). \tag{3.18}$$